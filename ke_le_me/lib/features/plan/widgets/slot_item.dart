...
class _SlotItemState extends State<SlotItem>
  ...
  Widget build(BuildContext context) {
    ...
    // IntrinsicHeight is needed because the timeline connector uses
    // Expanded to fill the vertical space between the dot and the next item.
    final innerRow = Row(
      children: [
        Container(
          ...
          child: Text(
            ...
            style: GoogleFonts.spaceMono(
              ...
              color: widget.isCompleted ? AppColors.green : AppColors.blue,
            ),
          ),
        ),
    ...
    final bool animateBorder = isUpcoming && !widget.isCompleted;
